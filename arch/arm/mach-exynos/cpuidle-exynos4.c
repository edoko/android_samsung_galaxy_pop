...
static int check_tdmb_op(void)
{
	/* This pin is high when tdmb is working */
	int tdmb_is_running = gpio_get_value(GPIO_TDMB_EN);

	if (tdmb_is_running != 0)
		printk(KERN_INFO "TDMB tdmb_is_running\n");
	return tdmb_is_running;
}
#endif
